...
[//]: # (I commented out these html image links because they don't produce self-contained html document)
...
- The package <a href="https://cran.r-project.org/web/packages/IBrokers/index.html" target="_blank"><em>*IBrokers*</em></a> contains *R* functions for communicating via the <a href="https://interactivebrokers.github.io/tws-api/" target="_blank">API of Interactive Brokers (IB API)</a>.  
...
- `realtimeBars()` updates the data environment with new data and then runs the trading model `model_fun()`.  
...
https://github.com/algoquant/presentations/RFinance_2019.html
