...
run_strategy <- function(excess, returns, typev, look_back, alpha, eigen_max, quantilev, coeff, bid_offer, lagg) {
  # browser()
...
inputPanel(
  ...
  sliderInput("eigen_max", label="max eigenvalues:",
...
pnls <- shiny::reactive({
  ...
  pnls <- run_strategy(excess, returns, typev, look_back, alpha, eigen_max, quantilev, coeff, bid_offer, lagg)
  cat("Model finished.\n")
  pnls
})  # end reactive code
