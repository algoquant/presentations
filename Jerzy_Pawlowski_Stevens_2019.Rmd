...
- We can define a simple market-making strategy as follows:  
...
- We can define a simple contrarian *EWMA* crossover strategy as follows:  
  ...
  if (is_contrarian) {
    if ((w_ap > ew_ma) & (posi_tion > 0)) {
      ...
      ib_order <- IBrokers2::twsOrder(
        ...
        totalQuantity=trade_params["siz_e"])
      IBrokers2::placeOrder(
        ib_connect, e_wrapper$da_ta$con_tracts[[contract_id]], ib_order)
...
- The residual of the regression determines the trade decision.  
...
- We can define a simple contrarian pairs trading strategy as follows:  
  - Place a market pairs *sell* order when the residual is above the trade threshold,  
  - Place a market pairs *buy* order when the residual is below the trade threshold.  
