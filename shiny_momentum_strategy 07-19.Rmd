...
run_strategy <- function(returns, typev, look_back, alpha, eigen_max, quantilev, coeff, bid_offer, lagg) {
  # browser()
...
renderPlot({
  ...
  # Run the trading strategy and plot it
  pnls <- run_strategy(returns, typev, look_back, alpha, eigen_max, quantilev, coeff, bid_offer, lagg)
