...
cap_tion <- paste("Z-score of VXX Regression Versus VTI Volatility and SVXY Prices")
...
ser_ver <- function(input, output) {
  ...
  pnl_s <- reactive({
    ...
    vari_ance <- HighFreq::roll_var_ohlc(ohlc=vt_i, look_back=look_back, scal_e=FALSE)
