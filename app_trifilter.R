##############################
# This is a shiny app for identifying isolated price spikes in 
# intraday data using a three-point classifier (tri-filter).
...
servfun <- shiny::shinyServer(function(input, output) {
  ...
  pricema <- shiny::reactive({
    ...
    colnames(pricema) <- c(symboln, "EMA Prices")
    pricema
  })  # end reactive code
