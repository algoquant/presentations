...
Rscript -e "shiny::runApp('/Users/jerzy/Develop/Presentations/strat_bollinger_price.R', host='127.0.0.1', port=3841, launch.browser=FALSE)"
-->
...
Rscript -e "shiny::runApp('/Users/jerzy/Develop/Presentations/strat_regime_vol.R', host='127.0.0.1', port=3843, launch.browser=FALSE)"
-->

<div onclick="fetch('http://127.0.0.1:3843/', { method: 'GET', mode: 'no-cors' }).then(() => { window.open('http://127.0.0.1:3843/', 'regimevolApp', 'popup,width=1100,height=800,resizable=yes,scrollbars=yes'); }).catch(() => {}); return false;" style="cursor:pointer;">
